  ...
  <div class="container">
    <div class="content">
      ...
      <p>
        ...
        Artikel 17 - Aanvullende of afwijkende bepalingen<br>
      </p>
      ...
      <ol>
        ...
        <li><strong>Consument</strong>:<strong />de natuurlijke persoon die niet handelt voor doeleinden die verband houden met zijn handels-, bedrijfs-, ambachts- of beroepsactiviteit; </li>
      ...
      </ol><h3>Artikel 2 - Identiteit van de ondernemer</h3>
      Naam ondernemer: WR Automaten<br>
      Handelend onder de naam/namen:<br>
      -  WR Automaten<br><br>
      Vestigingsadres: <br>
      Dijkgraafstraat 12<br>2922CG Krimpen aan den IJssel<br><br>
      Telefoonnummer: 0180510577<br>
      <br>
      Bereikbaarheid:<br>
      Van maandag t/m vrijdag vanaf 08.00 uur tot 18.00 uur<br><br>
      E-mailadres: wim@wr-automaten.nl<br>
      <br>
      KvK-nummer: 24350655<br>
      ...
      </ol><h3>Artikel 5 - De overeenkomst</h3>
      <ol>
      ...
      </ol><h3>Artikel 6 &ndash; Herroepingsrecht</h3>
      ...
      </ol><h3>Artikel 7 - Verplichtingen van de consument tijdens de bedenktijd</h3>
      <ol>
      ...
      </ol><h3>Artikel 8 - Uitoefening van het herroepingsrecht door de consument en kosten daarvan</h3>
      <ol>
        ...
        <li>
          De consument draagt geen kosten voor de volledige of gedeeltelijke levering van niet op een materi&euml;le drager geleverde digitale inhoud, indien:
          <ul>
      ...
      </ol><h3>Artikel 9 - Verplichtingen van de ondernemer bij herroeping</h3>
      <ol>
      ...
      </ol><h3>Artikel 10 - Uitsluiting herroepingsrecht</h3>
      ...
      <ol>
        ...
        <li>
          De levering van digitale inhoud anders dan op een materi&euml;le drager, maar alleen als:
          <ul>
            <li>de uitvoering is begonnen met uitdrukkelijke voorafgaande instemming van de consument; en</li>
            <li>de consument heeft verklaard dat hij hiermee zijn herroepingsrecht verliest.</li>
          </ul>
        </li>
      </ol><h3>Artikel 11 - De prijs</h3>
      <ol>
      ...
      </ol><h3>Artikel 12 - Nakoming overeenkomst en extra garantie </h3>
      <ol>
      ...
      </ol><h3>Artikel 13 - Levering en uitvoering</h3>
      <ol>
      ...
      </ol><h3>Artikel 14 - Duurtransacties: duur, opzegging en verlenging</h3>
      <p><em>Opzegging:</em></p>
      <ol>
      ...
      </ol><h3>Artikel 16 - Klachtenregeling</h3>
      <ol>
      ...
      </ol><h3>Artikel 17 - Aanvullende of afwijkende bepalingen</h3>
